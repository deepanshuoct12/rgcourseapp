    ...
    return (
        <section className="py-3">
            ...
            <div className="col-10 col-sm-8 mx-auto">
                <form  action="https://formspree.io/f/meqvjeak" method="POST">
                 ...
                 <div className="form-group">
                   <textarea type="text" name="description" id="description" placeholder="Your Description" className="form-control" />
                 </div>
